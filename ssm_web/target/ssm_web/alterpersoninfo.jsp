                            ...
                            <div id="lg1" class="tab-pane">
                                <div class="login-form-container">
                                    ...
                                    <div class="login-register-form">
                                        <form class="form-row" role="form" action="${pageContext.request.contextPath}/user/UpdataUser.do" method="post">
                                            <div class="login-input-box">
                                                <label >id</label>
                                                <input type="text" name="uid" placeholder="" readonly="readonly" value="${userinfo.uid}">
                                                <label >昵称</label>
                                                <input type="text" name="uname" placeholder="User Name" value="${userinfo.uname}">
                                                <label >密码</label>
                                                <input type="text" name="upwd" placeholder="Password" value="${userinfo.upwd}">
                                                <label>电话</label>
                                                <input type="tel" name="utel" placeholder="telephone" value="${userinfo.utel}">
                                                <label>性别</label>
                                                <select class="form-control" name="ugender" value="${userinfo.upwd}">
                                                    <option>男</option>
                                                    <option>女</option>
                                                </select>
                                                <label>出生年月</label><input type="date" name="birth" placeholder="date of birth" value="${userinfo.ubrith}">
                                                <%--</div>--%>
                                                <div class="button-box">
                                                    <button class="register-btn btn" onclick="changeuserinfo()" type="button"><span>完成</span></button>
                                                </div>
                                        </form>
                                    </div>
                                </div>
...
<script type="text/javascript">
    function changeuserinfo(){
        ...
        var utel =document.getElementsByName("utel")[0].value;
        ...
        $.ajax({
            type:"post",
            url:"${pageContext.request.contextPath}/user/UpdataUser.do",
            data:{uid:uid,uname:uname, upwd:upwd, utel:utel, ugender:ugender, birth:birth},
            dataType:"json",
            success:function(data){
                if(data.flag=="ok"){
                    alert('修改个人信息成功！点击确定返回用户登录界面！')
                    location.href="${pageContext.request.contextPath}/user/homepage.do";
