...
<div class="main-wrapper">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <ul class="breadcrumb-list">
                        <li class="breadcrumb-item"><a href="/mainmenu/getMainMenu.do">主页</a></li>
    ...
    <h2 class="text-center bigtitle">${tagClass.tcdetail}</h2>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <ul class="pagination-box">
                                        <%--<li></li>--%>
                                        <li ><a aria-label="Previous" href="${pageContext.request.contextPath}/checksametag/getSameMenu.do?tcid=${tagClass.tcid}&page=1&size=8" >首页</a></li>
